...
namespace gfx
{
    ...
    void SVGCanvas::DrawLine(double fromX, double fromY, double toX, double toY)
    {
        svgContent += "<line x1=\"" + std::to_string(fromX) + "\" y1=\"" + std::to_string(fromY)
            + "\" x2=\"" + std::to_string(toX) + "\" y2=\"" + std::to_string(toY)
